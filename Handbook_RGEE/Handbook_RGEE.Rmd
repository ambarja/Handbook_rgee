...
sen2 %>% 
  Map$addLayer(visParams = list(min = 450, max =3500, bands= c('B11','B8A','B2'), gamma = 0.5))
...
# Caso prático: SAR para el mapeo de descargas máximas y deslizamientos usando rgee 
